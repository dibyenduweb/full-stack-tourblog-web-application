...
const Banner = () => {
    return (
        <div className="lg:h-[500px] text-white  relative  lg:bg-cover text-center lg:py-44 bg-[rgba(0,0,0,0.5)] bg-blend-overlay bg-[url('https://dynamic.tourtravelworld.com/package-images/photo-big/dir_12/332226/185627.jpg')] ">
